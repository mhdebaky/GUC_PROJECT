package com.guc.covid19support.voip.udpcall;
...
public class MainCallActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        EditText displayNameText = findViewById(R.id.editTextDisplayNameMainCallActivity);
        ...
        btnCall.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(selectedButton == -1) {
                    ...
                    final AlertDialog alert = new AlertDialog.Builder(MainCallActivity.this).create();
                    alert.setTitle("Oops");
                ...
                Intent intent = new Intent(MainCallActivity.this, MakeCallActivity.class);
                    ...
                    while(LISTEN) {
                        ...
                        try {
                            ...
                            if(action.equals("CAL:")) {
                                ...
                                Intent intent = new Intent(MainCallActivity.this, RecieveCallActivity.class);
