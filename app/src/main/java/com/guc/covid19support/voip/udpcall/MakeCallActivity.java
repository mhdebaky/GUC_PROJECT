...
public class MakeCallActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        displayName = intent.getStringExtra(MainCallActivity.EXTRA_DISPLAYNAME);
        contactName = intent.getStringExtra(MainCallActivity.EXTRA_CONTACT);
        contactIp = intent.getStringExtra(MainCallActivity.EXTRA_IP);

        TextView textView = (TextView) findViewById(R.id.textViewCallingMakeCall);
        textView.setText("Calling: " + contactName);

        startListener();
        makeCall();

        Button endButton = (Button) findViewById(R.id.buttonEndCallMakeCall);
